...
# added mirostat v2 sampling functionality from git
...
# for tfs and top-a sampling
def get_logits_warper_patch(self, generation_config):
    warpers = self._get_logits_warper_old(generation_config)
    warpers_to_add = LogitsProcessorList()
    min_tokens_to_keep = 2 if generation_config.num_beams > 1 else 1
# adding in mirostat v2 sampling
    if generation_config.mirostat_mode is not None and generation_config.mirostat_mode == 2:
        ...
        # disabling other samplers except temperature
...
def generation_config_init_patch(self, **kwargs):
    ...
    # added mirostat_mode, mirostat_tau and mirostat_eta
