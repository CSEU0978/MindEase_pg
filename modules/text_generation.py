...
# Removed def fix_gpt4chan(s): empty replies from gpt4chan outputs
# removed def fix_galactica(s): fix for LaTeX equations in galactica
...
def formatted_outputs(reply, model_name):
   #removed formatting for gpt4chan
